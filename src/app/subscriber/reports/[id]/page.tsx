        ...
        <DashboardLayout role={UserRole.SUBSCRIBER}>
            <FadeInView delay={0.1} className="space-y-6 max-w-[1200px] mx-auto pb-12">
                ...
                <div className="flex items-center gap-2 text-xs md:text-sm text-slate-500 mb-2 overflow-hidden whitespace-nowrap">
                    <Link href="/subscriber/search" className="hover:text-primary transition-colors shrink-0">Reports</Link>
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 md:gap-6 pb-2">
                    <div className="flex items-center gap-3 md:gap-5">
                        ...
                        <div className="min-w-0">
                            <h1 className="text-2xl md:text-4xl font-extrabold text-slate-900 tracking-tight leading-tight truncate">Vehicle Report</h1>
                    ...
                    <Button
                        ...
                        className={cn(
                            "h-11 md:h-12 px-6 md:px-8 rounded-xl md:rounded-2xl font-bold gap-2 transition-all shadow-sm border-slate-200 w-full sm:w-auto",
                        ...
                        <Card className="border-none shadow-sm rounded-2xl md:rounded-[32px] overflow-hidden bg-white p-6 md:p-8">
                            <div className="flex items-center justify-between gap-4">
                                ...
                                <div className="text-right min-w-0">
                                    <Label className="text-[10px] font-bold text-slate-400 tracking-widest uppercase mb-1 block">Report ID</Label>
