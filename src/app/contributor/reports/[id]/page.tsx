        ...
        <DashboardLayout role={UserRole.CONTRIBUTOR}>
            <FadeInView delay={0.1} className="space-y-6 max-w-[1200px] mx-auto pb-12">
                ...
                <div className="flex items-center gap-2 text-sm text-slate-500 mb-2">
                    <Link href="/contributor/reports" className="hover:text-primary transition-colors">My Submissions</Link>
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 pb-2">
                    <div className="flex items-center gap-5">
                        ...
                        <div>
                            <h1 className="text-4xl font-extrabold text-slate-900 tracking-tight leading-tight">Submission Details</h1>
